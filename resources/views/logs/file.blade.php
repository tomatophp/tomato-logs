<x-tomato-admin-layout>
    ...
    <div class="bg-white dark:bg-zinc-800 shadow overflow-hidden sm:rounded-lg mb-6">
        ...
        <div class="border-t border-zinc-200 dark:border-zinc-700 overflow-x-scroll w-full bg-zinc-50 dark:bg-zinc-700">
            <dl>
                <div class="bg-zinc-50 dark:bg-zinc-700 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm font-medium text-zinc-500 dark:text-zinc-200">
                        {{trans('tomato-logs::global.date')}}
                    </dt>
                    <dd class="mt-1 text-sm text-zinc-900 sm:mt-0 sm:col-span-2 dark:text-zinc-300">
                        {{$record->date}}
                    </dd>
                </div>
                <div class="bg-white dark:bg-zinc-800 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt class="text-sm font-medium text-zinc-500 dark:text-zinc-200">
                ...
                <div class="bg-zinc-50 dark:bg-zinc-700 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd class="mt-1 text-sm text-zinc-900 sm:mt-0 sm:col-span-2 dark:text-zinc-300">
                        ...
                        @else
                        <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-zinc-100 text-zinc-800">
                            {{$record->level}}
                        </span>
                        @endif
                    </dd>
                ...
                <div class="bg-zinc-50 dark:bg-zinc-700 px-4 pb-5">
                ...
                <div class="bg-white dark:bg-zinc-800 px-4 pt-5">
                    <dt class="text-sm font-medium text-zinc-500 dark:text-zinc-200">
                        {{trans('tomato-logs::global.stack')}}
                    </dt>
                </div>
                <div class="bg-white dark:bg-zinc-800 px-4 py-5 w-full">
                    <dd class="mt-1 text-sm text-zinc-900 dark:text-zinc-200 overflow-x-auto">
                        @php $counter = 0; @endphp
                        @foreach($record->stack_traces as $key=>$stackTrace)
                        <div
                            class="border-zinc-200 dark:border-zinc-600 py-3  border-t">
                            <div class="grid grid-cols-3 w-full py-0.5 px-1 hover:bg-zinc-100 dark:hover:bg-zinc-600 rounded">
                            ...
                            <div class="grid grid-cols-3 w-full pt-0.5 px-1 hover:bg-zinc-100 dark:hover:bg-zinc-600 rounded">
